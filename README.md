# Juh Design — estúdio criativo

App de design em português baseado no OpenDesign. Nove modelos editáveis para interfaces, branding, social media, vetores, catálogos e design systems, com prévia ao vivo e exportação HTML/SVG/JSON.

**[Guia de uso e instalação](JUH-DESIGN.md)** · Inicie o app e abra `/estudio`.

A geração por IA usa os provedores e agentes configurados no OpenDesign. O estúdio local funciona com modelos editáveis e mantém o projeto no navegador.
